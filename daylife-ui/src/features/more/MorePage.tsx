...
import {
  ...
  ChevronRight, Shield, Brain, Lightbulb, Navigation, Film, HelpCircle,
} from 'lucide-react';

const menuItems = [
  { path: '/life', label: 'Life Dashboard', hint: 'AI scores, patterns, predictions', icon: Brain, color: 'text-violet-600 bg-violet-50' },
  { path: '/gps', label: 'Life GPS', hint: 'Where your life is heading', icon: Navigation, color: 'text-slate-700 bg-slate-50' },
  { path: '/decide', label: 'AI Decisions', hint: 'Should I buy this? AI checks', icon: HelpCircle, color: 'text-indigo-600 bg-indigo-50' },
  { path: '/replay', label: 'Life Replay', hint: 'Monthly recap — your movie', icon: Film, color: 'text-amber-600 bg-amber-50' },
