...
import { api, Expense, ExpenseCategory, SplitMode, User } from '../../lib/api';
...
export function ExpenseFormModal({ expense, members, splitEnabled = false, defaultDate, onClose }: Props) {
  ...
  const equalSharePreview = useMemo(() => {
    ...
    const per = total / participantIds.length;
